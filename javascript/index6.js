// 문자열에서 사용하는 메소드
// length
// toUpperCase, toLowerCase, trime, indexOf, slic
...
// Sonny 단어 만들기
console.log(str1[0] + str1[12] + str1[str1.length-1] + str1[str1.length-1] + str1[9])
...
// join(''), 배열 > 문자열로 병합
str1 = arr1.join()
// join의 인자에 아무것도 전달이 되지 않으면
// 배열 안의 컴마까지 값이 문자열로 반환됨
console.log(str1) 
str1 = arr1.join('')
console.log(str1)
...
// forEach(익명함수)
// forEach(function(a[, b, c])) -> a는 꼭 써야하지만, b와 c는 꼭 쓰지 않아도된다.
